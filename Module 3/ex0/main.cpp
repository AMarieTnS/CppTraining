...
int main() {
  ...
  // ex04
  std::cout << std::endl << "############EX04############" << std::endl;
  Claptrap4.rangedAttack("target1");
  Claptrap4.meleeAttack("target3");

  Claptrap4.ninjaShoebox(Claptrap1);
  Claptrap4.vaulthunter_dot_exe("target1");
  return 0;
}